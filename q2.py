...
#I used numpy becuase it is the best and most efficient way of arranging the data into ranges and then converting that histogram into bar graph however it could have been done without that as well 
